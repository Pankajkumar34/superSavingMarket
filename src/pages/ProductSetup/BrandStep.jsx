...
const tabs = [
    { label: "Brand", tabPath: "brand" },
    { label: "Category", tabPath: "category" },
    { label: "Sub Category", tabPath: "subcategory" },
]
...
export default function AddBrand() {
    ...
    const handleImagesChange = async (e, index) => {
        ...
        try {
            ...
            // console.log(urls, "===> file upload res");
            ...
            setBrands(prev => {
                const updated = [...prev];
                updated[index] = { ...updated[index], logo: urls[0] };
                return updated;
            });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate(`/add-product/category-add`);
            ...
            <div className="min-h-screen bg-gray-100 p-6 flex justify-center">
                ...
                >
                    ...
                    <div className="text-right">
                        <button
                            disabled={loading}
                            className=" bg-[#dc401f] hover:bg-[#11395c] text-white px-6 py-2 rounded-xl disabled:opacity-50"
                        >
